...
<div class="kblock">
	<div class="kheader">
		<h2><span><?php echo $this->escape($this->topic->subject) ?></span></h2> <!-- <a href="/J25test/index.php?option=com_kunena&view=topic&defaultmenu=477&Itemid=475&task=rate&stars=3&id=8&catid=2&<?php //echo JSession::getFormToken()?>=1">testlink</a> -->
